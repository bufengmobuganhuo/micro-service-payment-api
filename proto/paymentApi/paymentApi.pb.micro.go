...
type PaymentApiService interface {
	// 直接退款功能
	AliPayRefund(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
}
...
func (c *paymentApiService) AliPayRefund(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "PaymentApi.AliPayRefund", in)
	out := new(Response)
...
type PaymentApiHandler interface {
	// 直接退款功能
	AliPayRefund(context.Context, *Request, *Response) error
}

func RegisterPaymentApiHandler(s server.Server, hdlr PaymentApiHandler, opts ...server.HandlerOption) error {
	type paymentApi interface {
		AliPayRefund(ctx context.Context, in *Request, out *Response) error
	}
...
func (h *paymentApiHandler) AliPayRefund(ctx context.Context, in *Request, out *Response) error {
	return h.PaymentApiHandler.AliPayRefund(ctx, in, out)
}
